...
CURSOS_CONFIRMATION_CC_EMAIL = env("CURSOS_CONFIRMATION_CC_EMAIL", default="")
...
MIGRATION_MODULES = {"sites": "cyment_com.contrib.sites.migrations"}
...
STATICFILES_DIRS = [str(BASE_DIR / "frontend/public")]
...
# Replaces the deprecated ACCOUNT_AUTHENTICATION_METHOD = "email".
ACCOUNT_LOGIN_METHODS = {"email"}
# https://docs.allauth.org/en/latest/account/configuration.html
# Replaces the deprecated ACCOUNT_EMAIL_REQUIRED / ACCOUNT_USERNAME_REQUIRED
# pair: "*" marks a field as required, and username is simply absent.
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "cyment_com.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "cyment_com.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "cyment_com.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Cyment.com API",
    "DESCRIPTION": "Documentation of API endpoints of Cyment.com",
    "VERSION": "1.0.0",
